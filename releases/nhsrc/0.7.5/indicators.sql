...
-- MONTHLY OUTPUT
  ...
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Neonatal asphyxia rate in Inborn Babies ', 'Percentage', '((numberOfNewbornsDevelopedAsphyxia*100)/(numberOfVaginalDeliveries+numberOfAssistedVaginalDeliveries+numberOfCSectionDeliveries))', true, 10600, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Neonatal sepsis rate in-born babies', 'Percentage', '((numberOfNewbornsDevelopedSepsis*100)/(numberOfVaginalDeliveries+numberOfAssistedVaginalDeliveries+numberOfCSectionDeliveries))', true, 10700, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Surgical Site infection Rate in Maternity OT', 'Percentage', '((numberOfCSectionsWithSurgicalSiteInfection*100)/(numberOfCSectionDeliveries))', true, 10800, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Antenatal corticosteroid administration rate in case in preterm labour', 'Percentage', '((numberOfPretermAdministeredANCS*100)/(numberOfPretermDeliveries))', true, 10900, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Pre-eclampsia, eclampsia & PIH related mortality', 'Percentage', '((numberOfMaternalDeathsForPIHEclampsia*100)/(numberOfMaternalDeaths))', true, 11000, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('APH/PPH related mortality', 'Percentage', '((numberOfAPHMaternalDeaths + numberOfPPHMaternalDeaths)*100)/(numberOfMaternalDeaths))', true, 11100, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Facility Labour Room is reorganized as labour room standardization guidelines', 'Coded', '(facilityHasReorganizedLR)', true, 11200, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Facility Labour room has staffing as per defined norms', 'Coded', '(facilityHasAdequateStaffAtLR)', true, 11300, monthly_at_id);
  ...
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('OSCE Score', 'Percentage', '(cuurentOSCEScore)', true, 11500, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Facility conducts referral audit on Monthly basis', 'Coded', '(numberOfReferralCasesReviewed)', true, 11600, monthly_at_id);
  ...
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Facility report zero stock outs in Labour Room & Maternity OT', 'Coded', '(anyStockoutsOfDrugsAndConsumablesInMaternityOT)', true, 11800, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Still Birth Rate', 'Percentage', '((numberOfMaceratedStillBirths + numberOfStillBirths)*100/(numberOfVaginalDeliveries+numberOfAssistedVaginalDeliveries+numberOfCSectionDeliveries))', true, 11900, monthly_at_id);
  ...
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Functional Obs ICU/Hybrid ICU/HDU', 'Coded', '(hasFunctionalObsICUHDU)', true, 12100, monthly_at_id);
  INSERT INTO indicator_definition (name, data_type, formula, output, sort_order, assessment_tool_id) VALUES ('Microbiological Surveillance in OT & LR', 'Coded', '(microbioOTSampleCollectedAsPerProtocol && microbioLRSampleCollectedAsPerProtocol)', true, 12200, monthly_at_id);
END;
$$ LANGUAGE plpgsql; 
